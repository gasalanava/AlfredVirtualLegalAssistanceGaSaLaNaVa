(()=>{
 ...
 const screens=["homeCard","directDestCard","directValidateCard","identifyResultCard","lastResultCard","legalCard","destRouteCard","destinationCard","temporaryCard","checkCard","finalCard"];
